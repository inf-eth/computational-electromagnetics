...
dt = fread (fidp, 1, 'double');
k0 = fread (fidp, 1, 'double');
z1 = fread (fidp, 1, 'double');
z2 = fread (fidp, 1, 'double');
...
for i=1:simTime
    ...
    ExSnapshot = fread (fid, size, 'double');
    figure (6)
