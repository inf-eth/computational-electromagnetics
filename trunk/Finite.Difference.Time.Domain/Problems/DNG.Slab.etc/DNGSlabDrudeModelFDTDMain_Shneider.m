% DNG Slab simulation based on 2D FDTD template for Drude Model with isotropic constitutive parameters from 10.4-5 JB Shneider.
...
[Size XCenter YCenter delta ISlab JSlab DTp] = Parameters;
IHx = Size;
JHx = Size-1;
IHy = Size+1;
JHy = Size;
...
Js = 60;                         % J-position of the plane wave front.
...
%     if ( n < NHW )
        Ez ( Size/2, Js, n1 ) = Ez ( Size/2 + 1, Js, n1 ) + 1 * sin ( TwoPIFDeltaT * n );
%     end
