...
__kernel void FDTD2DDNGKernel_DryRun_M(
							...
							const __glbobal PRECISION *Ez_, const __glbobal PRECISION *Dz_, __glbobal PRECISION *Hx_, __glbobal PRECISION *Bx_, __glbobal PRECISION *Hy_, __glbobal PRECISION *By_,
							const __glbobal PRECISION *PsiEzX_, const __glbobal PRECISION *PsiEzY_, __glbobal PRECISION *PsiHyX_, __glbobal PRECISION *PsiHxY_,
							const __glbobal PRECISION *einf_, const __glbobal PRECISION *uinf_,
