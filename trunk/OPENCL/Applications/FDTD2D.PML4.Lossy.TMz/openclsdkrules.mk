...
ifdef release
SDK_UTIL_LIBS := $(AMDAPPSDKROOT)/samples/opencl/SDKUtil/$(OUTPUTDIR)/$(LIBPREFIX)SDKUtil$(STATIC_LIBSUFFIX)
else
SDK_UTIL_LIBS := $(AMDAPPSDKROOT)/samples/opencl/SDKUtil/$(OUTPUTDIR)/$(LIBPREFIX)SDKUtil$(STATIC_LIBSUFFIX)
endif
endif
...
FASTDEPS   := $(AMDAPPSDKROOT)/make/fastdep.pl

DEPNDS_INC_DIR := -I$(AMDAPPSDKROOT)/include
