 ...
 *
 */
typedef CALresult (CALAPIENTRYP PFNCALREADATOMICCOUNTER) (CALdevice dev,
                                                          CALuint index,
                                                          CALuint* value);
 ...
 *
 */
typedef CALresult (CALAPIENTRYP PFNCALWRITEATOMICCOUNTER) (CALdevice dev,
                                                           CALuint index,
                                                           CALuint value);
