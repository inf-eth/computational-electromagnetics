...
makedirectories:
#	$(VERBOSE)mkdir -p $(LIBDIR)	Should be make'ed in SDK root folder.
...
#	$(VERBOSE)rm -f $(ROOTBINDIR)/$(OSLOWER)/$(BINSUBDIR)/*.txt
	...
	$(VERBOSE)rm -rf FieldData/*.fdt
	$(VERBOSE)rm -rf FieldData/*.smp
#	$(VERBOSE)rm -rf $(LIBDIR)		Should be removed in SDK root folder.
